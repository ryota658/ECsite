...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($kashimamenus); $i++): ?>
  <?php if ($_GET['name'] == $kashimamenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $kashimamenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/kashima.png"><span>鹿島アントラーズ</span></p>
        <p><?php echo $kashimamenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $kashimamenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $kashimamenus[$i]->getName() ?>">

...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($gosakamenus); $i++): ?>
  <?php if ($_GET['name'] == $gosakamenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $gosakamenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/gosaka.png"><span>ガンバ大阪</span></p>
        <p><?php echo $gosakamenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $gosakamenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $gosakamenus[$i]->getName() ?>">

...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($shonanmenus); $i++): ?>
  <?php if ($_GET['name'] == $shonanmenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $shonanmenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/shonan.png"><span>湘南ベルマーレ</span></p>
        <p><?php echo $shonanmenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $shonanmenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $shonanmenus[$i]->getName() ?>">

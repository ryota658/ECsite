...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($kashiwamenus); $i++): ?>
  <?php if ($_GET['name'] == $kashiwamenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $kashiwamenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/kashiwa.png"><span>柏レイソル</span></p>
        <p><?php echo $kashiwamenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $kashiwamenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $kashiwamenus[$i]->getName() ?>">

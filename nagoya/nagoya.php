...
<div class="header_in header_nagoya">
  <h1><img src="../image/nagoya.png">名古屋グランパス</h1>
</div>
<!-- ■■■■ スライダー ■■■■ -->
<ul class="slider">
...
<div class="wrapper">
<h2>オリジナルグッズ</h2>
  <?php foreach($nagoyamenus as $nagoyamenu): ?>
  <!-- ■■■■ セクション ■■■■ -->
  <section class="card">
  <p><a href="show.php?name=<?php echo $nagoyamenu->getName() ?>"></p>
  <p class="image_css"><img src="../<?php echo $nagoyamenu -> getImage() ?>"></p>
  <p class="menu_css"><?php echo $nagoyamenu->getName() ?></p>
  <p class="price_css"><?php echo $nagoyamenu->getTaxPrice() ?><span>円(税込み)</span></p></a>
  </section>
  <?php endforeach ?>
<!-- ■■■■ 公式SNS ■■■■ -->
  <div class="shop_wrap shop_nagoya">
    <h2><span>Official Shop</span>オフィシャルグッズはここでも買える！</h2>
    <div class="shop_section">
      <section class="shop">
      <h3>クラブグランパス</h3>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3261.9272216278914!2d136.89987031559858!3d35.15843576607201!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x600377ba94b56d83%3A0xd931f8c680e86e83!2z44Kv44Op44OW44Kw44Op44Oz44OR44K5!5e0!3m2!1sja!2sjp!4v1613263307865!5m2!1sja!2sjp" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        <p>所在地：〒460-0011 愛知県名古屋市中区大須３丁目３８−９</p>
        <p>open:11:00～18:00</p>
      </section>
      <section class="shop">
        <h3>豊田スタジアム</h3>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3264.88681091759!2d137.16873131524255!3d35.084560780337654!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6004a0599ad28d2f%3A0xdd3fe874a2ca74db!2z6LGK55Sw44K544K_44K444Ki44Og!5e0!3m2!1sja!2sjp!4v1613263423652!5m2!1sja!2sjp" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        <p>所在地：〒471-0016 愛知県豊田市千石町７丁目２</p>
      </section>
    </div>
  </div>
</div>

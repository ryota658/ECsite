...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($nagoyamenus); $i++): ?>
  <?php if ($_GET['name'] == $nagoyamenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $nagoyamenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/nagoya.png"><span>名古屋グランパス</span></p>
        <p><?php echo $nagoyamenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $nagoyamenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $nagoyamenus[$i]->getName() ?>">

...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($urawamenus); $i++): ?>
  <?php if ($_GET['name'] == $urawamenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $urawamenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/kashima.png"><span>鹿島アントラーズ</span></p>
        <p><?php echo $urawamenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $urawamenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $urawamenus[$i]->getName() ?>">

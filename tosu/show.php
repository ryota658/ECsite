...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($tosumenus); $i++): ?>
  <?php if ($_GET['name'] == $tosumenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $tosumenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/tosu.png"><span>サガン鳥栖</span></p>
        <p><?php echo $tosumenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $tosumenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $tosumenus[$i]->getName() ?>">

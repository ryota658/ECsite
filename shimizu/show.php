...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($shimizumenus); $i++): ?>
  <?php if ($_GET['name'] == $shimizumenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $shimizumenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/shimizu.png"><span>清水エスパルス</span></p>
        <p><?php echo $shimizumenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $shimizumenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $shimizumenus[$i]->getName() ?>">

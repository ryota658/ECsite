...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($cosakamenus); $i++): ?>
  <?php if ($_GET['name'] == $cosakamenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $cosakamenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/cosaka.png"><span>セレッソ大阪</span></p>
        <p><?php echo $cosakamenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $cosakamenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $cosakamenus[$i]->getName() ?>">

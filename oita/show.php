...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($oitamenus); $i++): ?>
  <?php if ($_GET['name'] == $oitamenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $oitamenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/oita.png"><span>大分トリニータ</span></p>
        <p><?php echo $oitamenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $oitamenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $oitamenus[$i]->getName() ?>">

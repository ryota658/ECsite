...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($fctokyomenus); $i++): ?>
  <?php if ($_GET['name'] == $fctokyomenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $fctokyomenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/fctokyo.png"><span>FC東京</span></p>
        <p><?php echo $fctokyomenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $fctokyomenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $fctokyomenus[$i]->getName() ?>">

...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($kobemenus); $i++): ?>
  <?php if ($_GET['name'] == $kobemenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $kobemenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/kobe.png"><span>ヴィッセル神戸</span></p>
        <p><?php echo $kobemenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $kobemenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $kobemenus[$i]->getName() ?>">

...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($hiroshimamenus); $i++): ?>
  <?php if ($_GET['name'] == $hiroshimamenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $hiroshimamenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/hiroshima.png"><span>サンフレッチェ広島</span></p>
        <p><?php echo $hiroshimamenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $hiroshimamenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $hiroshimamenus[$i]->getName() ?>">

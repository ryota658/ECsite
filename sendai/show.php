...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($sendaimenus); $i++): ?>
  <?php if ($_GET['name'] == $sendaimenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $sendaimenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/sendai.png"><span>ベガルタ仙台</span></p>
        <p><?php echo $sendaimenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $sendaimenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $sendaimenus[$i]->getName() ?>">

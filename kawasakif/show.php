...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($kawasakifmenus); $i++): ?>
  <?php if ($_GET['name'] == $kawasakifmenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $kawasakifmenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/kawasakif.png"><span>川崎フロンターレ優勝記念グッズ</span></p>
        <p><?php echo $kawasakifmenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $kawasakifmenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $kawasakifmenus[$i]->getName() ?>">

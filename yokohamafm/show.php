...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($yokohamafmmenus); $i++): ?>
  <?php if ($_GET['name'] == $yokohamafmmenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $yokohamafmmenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/yokohamafm.png"><span>横浜F・マリノス</span></p>
        <p><?php echo $yokohamafmmenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $yokohamafmmenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $yokohamafmmenus[$i]->getName() ?>">

...
<div class="header_in header_yokohamafc">
  <h1><img src="../image/yokohamafc.png">横浜FC</h1>
</div>
<!-- ■■■■ スライダー ■■■■ -->
<ul class="slider">
...
<div class="wrapper">
<h2>オリジナルグッズ</h2>
  <?php foreach($yokohamafcmenus as $yokohamafcmenu): ?>
  <!-- ■■■■ セクション ■■■■ -->
  <section class="card">
  <p><a href="show.php?name=<?php echo $yokohamafcmenu->getName() ?>"></p>
  <p class="image_css"><img src="../<?php echo $yokohamafcmenu -> getImage() ?>"></p>
  <p class="menu_css"><?php echo $yokohamafcmenu->getName() ?></p>
  <p class="price_css"><?php echo $yokohamafcmenu->getTaxPrice() ?><span>円(税込み)</span></p></a>
  </section>
  <?php endforeach ?>
<!-- ■■■■ 公式SNS ■■■■ -->
  <div class="shop_wrap shop_yokohamafc">
    <h2><span>Official Shop</span>オフィシャルグッズはここでも買える！</h2>
    <div class="shop_section">
      <section class="shop">
        <h3>ニッパツ三ツ沢球技場</h3>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3249.419839441544!2d139.60163001525305!3d35.469154880244304!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60185bfbf787bab7%3A0x2809713be7170ff3!2z44OL44OD44OR44OE5LiJ44OE5rKi55CD5oqA5aC0!5e0!3m2!1sja!2sjp!4v1613304542589!5m2!1sja!2sjp" width="400" height="300" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        <p>所在地：〒221-0855 神奈川県横浜市神奈川区三ツ沢西町３−１</p>
      </section>
    </div>
  </div>
</div>

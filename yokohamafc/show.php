...
<!-- ■■■■ セクション ■■■■ -->
<?php for ($i=0; $i < count($yokohamafcmenus); $i++): ?>
  <?php if ($_GET['name'] == $yokohamafcmenus[$i]->getName()):?>
    <section class="section">
      <div class="section_IMG">
        <p class="image_show"><img src="../<?php echo $yokohamafcmenus[$i] -> getImage() ?>"></p>
      </div>
      <div class="section_contents">
        <p><img src="../image/yokohamafc.png"><span>横浜FC</span></p>
        <p><?php echo $yokohamafcmenus[$i]->getName() ?></p>
        <p>価格:<span><?php echo $yokohamafcmenus[$i]->getTaxPrice() ?>円</span>(税込み)</p>
        <p>個数:<select class="select" name=" <?php echo $yokohamafcmenus[$i]->getName() ?>">
